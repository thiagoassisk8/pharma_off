...
class Higiene extends StatelessWidget {
  ...
  List<Produto> higieneLista = Produto.higienelist;
  @override
                                      ...
                                      child: Stack(
                                        children: <Widget>[
                                          ...
                                          Positioned(
                                            ...
                                            child: Hero(
                                              tag:
                                                  "hero${higieneLista[index].imgPath}",
                                              child: Transform.rotate(
                                                angle: -math.pi / 27,
                                                child: Image(
                                                  width: 220,
                                                  image: AssetImage(
                                                      "assets/images/${higieneLista[index].imgPath}"),
                                                ),
                                              ),
                                            ),
                                          ),
