...
import 'package:pharma_off/home/rest_api/BuscaCuidados.dart';
...
class Pele extends StatefulWidget {
  ...
  @override
  _PeleState createState() => _PeleState();
}

class _PeleState extends State<Pele> {
  List cuidadoData;
  ...
  Future getProdutosCuidado() async {
    var listProdutosPele = await APIGetCuidado().getAllCuidadoprods();

    cuidadoData = [];
    for (var produto in listProdutosPele.data) {
      cuidadoData.add(produto);
    }
    return cuidadoData;
  }

  Widget buildList() => FutureBuilder(
      future: getProdutosCuidado(),
                              ...
                              child: Stack(
                                children: <Widget>[
                                  ...
                                  Positioned(
                                    ...
                                    // tag: "hero${cuidadoData[index].imgPath}",
